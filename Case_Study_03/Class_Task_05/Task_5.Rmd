...
library(ggplot2)
library(tidyverse)
diamonds1 <- filter(diamonds, price < "2050" & price > "1950")
diamonds2 <- filter(diamonds1, clarity != "SI1" & clarity != "VS1" & clarity != "VVS1")
diamonds3 <- filter(diamonds2, clarity != "I1" & clarity != "SI2" & clarity != "IF" & cut != "Fair" & cut != "Good")
